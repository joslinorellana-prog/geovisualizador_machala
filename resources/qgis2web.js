...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:32717',
            //extent: [613760.830524, 9640037.780737, 616221.662230, 9641612.513454],
            units: 'm'
        })
    })
});
...
map.getView().fit([613165.210731, 9639900.214565, 616808.183860, 9641815.592190], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Geovisualizador_Machala Orellana J. Roque A.</h2>';
        return titleElement;
    })(),
