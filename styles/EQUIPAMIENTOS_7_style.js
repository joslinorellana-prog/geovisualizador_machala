...
function categories_EQUIPAMIENTOS_7(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        image: new ol.style.Circle({radius: 8.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(50,87,128,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(39,130,235,1.0)'})}),
